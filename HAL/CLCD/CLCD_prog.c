...
{
	char Local_cbuff[16];             /* String to hold the ASCII result */
	itoa(Copy_u32data, Local_cbuff, 10);      /* Use itoa C function to convert the data to its corresponding ASCII value, 10 for decimal */
	HCLCD_voidSendString(Local_cbuff);   /* Display the string */
}
